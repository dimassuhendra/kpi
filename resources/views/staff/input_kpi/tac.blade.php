            ...
            <div class="bg-slate-50 p-4 rounded-xl border border-slate-200 flex flex-col justify-center">
                <div class="mb-2">
                    ...
                    <div
                        ...
                        <i class="fas fa-clock mr-1"></i> Ketepatan waktu input Dashboard KPI Anda (Maks. 2 Jam setelah
                        jam pulang Shift) <strong>akan terekam secara otomatis</strong> oleh sistem saat Anda menekan
                        tombol Submit Laporan di bawah. Tidak perlu melampirkan bukti gambar.
                    </div>
                </div>
            </div>
        </div>
...
{{-- SECTION 2A: TECHNICAL CASES NETWORK --}}
<div class="mb-10">
    <h2 class="text-xl font-bold text-slate-800 mb-4 flex items-center">
        <span
                            ...
                            <div>
                                <div class="bg-white p-3 rounded-lg border border-slate-200 h-full flex flex-col">
                                    <label class="text-[10px] uppercase text-slate-400 font-black mb-2 block">Status
                                        Penyelesaian</label>
                                    <select :name="'case_network[' + index + '][is_mandiri]'" x-model="row.is_mandiri"
                                    ...
                                    <div x-show="row.is_mandiri == 0" x-transition>
                                        <label class="text-[10px] uppercase text-rose-400 font-black mb-1 block">Nama
...
{{-- SECTION 2B: TECHNICAL CASES GPS --}}
<div class="mb-10">
    <h2 class="text-xl font-bold text-slate-800 mb-4 flex items-center">
        <span
