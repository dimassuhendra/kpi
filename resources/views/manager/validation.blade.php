                ...
                <div class="flex justify-between items-start">
                    <div>
                        ...
                        <p class="text-[10px] text-slate-500 uppercase mt-1">
                            <i class="far fa-calendar-alt mr-1"></i> {{ \Carbon\Carbon::parse($rp->tanggal)->format('d M Y') }}
                        </p>
                    </div>
                    <span class="text-[9px] bg-amber-500/10 text-amber-500 px-2 py-1 rounded font-bold italic tracking-tighter">WAITING</span>
                </div>
            </div>
            @empty
    ...
    <div class="w-full md:w-2/3 organic-card overflow-hidden flex flex-col border-white/10 shadow-2xl relative">
        <div id="detail-container" class="flex-grow overflow-y-auto p-8 custom-scrollbar">
            <div class="h-full flex flex-col justify-center items-center text-slate-600">
                ...
                <p class="text-[10px] text-slate-500 mt-2 uppercase">Pilih laporan di sisi kiri untuk memvalidasi aktivitas</p>
            </div>
        </div>
    </div>
</div>
