...
<head>
    ...
    <script defer src="https://cdn.jsdelivr.net/npm/alpinejs@3.x.x/dist/cdn.min.js"></script> <!-- Ekstensi alpine js untuk transisi tanpa load halaman -->
    <script src="https://cdn.jsdelivr.net/npm/chart.js"></script> <!-- Ekstensi chart -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/html2canvas/1.4.1/html2canvas.min.js"></script> <!-- Ekstensi untuk download chart ke jpg -->
